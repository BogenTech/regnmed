<script>
  ...
  // ett skjermbilde mindre å lete i. Leverandørene bor fortsatt i
  // Reskontro; kundens selskabstilknytning er fast og vises ikke som
  // noe valg.
...
{:else if extra}
  <a class="btn btn-ghost btn-sm mb-2" href={"#/c/" + companyId + "/kunder"}>← Kunder</a>
