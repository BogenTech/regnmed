...
//!
//! Bokføringsvalutaen er NOK; dokumenter bærer transaksjonsvalutaen.
//! Alt er heltall: valutabeløp i valutaens minste enhet (cent), kurs i
//! mikro-NOK per valutaenhet (11,6543 kr/EUR → 11_654_300). Omregning
//! avrundes halvt vekk fra null per beløp — summer er summer av
//! avrundede deler, aldri omvendt (dokumentert i docs/valuta.md).
//!
//! Valutainformasjonen på en posteringslinje er bevis og dekkes av
//! hash format v4 ([`crate::hash`]).

/// Valutainformasjon på en posteringslinje (hash format v4): hva
/// transaksjonen lød på, og kursen den ble bokført til.
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct Valuta {
    /// ISO 4217-kode, alltid store bokstaver, aldri "NOK".
    pub valuta: String,
    /// Beløp i valutaens minste enhet; fortegn som NOK-beløpet.
    pub belop_cent: i64,
    /// NOK per valutaenhet i mikro-NOK.
    pub kurs_micro: i64,
}

/// cent × kurs → øre, halvt vekk fra null.
